...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      onTouchStart={(e) => {
        // Ensure touch fires the click handler on mobile
        e.currentTarget.click();
      }}
      onKeyDown={handleKeyDown}
      className={`relative inline-flex items-center justify-center rounded-full bg-[#120F17] border-neutral-700 border-2 shadow-md cursor-pointer touch-manipulation ${className}`}
      tabIndex={0}
      role="button"
      aria-haspopup="true"
